...
import '../Add/AddLabel.dart';
import '../../database/repository.dart';
class EditLabel extends StatefulWidget {
  final Label ct;
  const EditLabel({Key? key,required this.ct}) : super(key: key);

  @override
  State<EditLabel> createState() => _EditCategoryrState();
}

class _EditCategoryrState extends State<EditLabel> {
                  ...
                  TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_validateName == false) {
                          ...
                          var result=await rep.updateCat("Labelnotes", _user.lblMap()!);
